...
const CACHE = 'agrav-v1';
const ASSETS = [
  './', './index.html', './manifest.webmanifest',
  './src/main.js', './src/net.js', './src/input.js', './src/hud.js', './src/audio.js', './src/settings.js',
  './src/render/track.js', './src/render/vehicle.js', './src/render/fx.js', './src/render/textures.js',
  ...
  '../shared/agrav/tracks/canyon.js', '../shared/agrav/tracks/vanta.js',
